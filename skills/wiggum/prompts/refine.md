...
- **Code philosophy alignment**: Check against the Code Philosophy in `.wiggum/AGENTS.md`
...
2. Make agreed-upon changes to `.wiggum/` files (plan, specs, AGENTS.md as needed)
